...
> **Census:** 46 Lean files, 260 theorems, 16 axioms, 0 sorry, 89 definitions, 42 experiment scripts, 32 JSON result files, 12 figures
...
| # | Finding | What It Shows |
|---|---------|---------------|
| I1 | 260 theorems, 16 axioms, 0 sorry, 46 files | Scale of verification |
