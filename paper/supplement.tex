...
The formalization comprises 14 Lean~4 files (15 axioms, 24 substantive
theorems + 9 convenience lemmas, 0 \texttt{sorry}).
...
\[
    ...
    \frac{\pi - 2}{n} + O(n^{-2})\right)
\]
For $n = 2000$ (our synthetic setting), the correction is
$\Delta\alpha_1 \approx 0.0004$---negligible.
\end{proposition}
