...
Seven distinct features compete for the top-3 positions on Breast Cancer: worst concave points, mean concave points, worst area, worst concavity, worst texture, worst perimeter, and area error. The \#1 position alternates: worst concave points (50\%), mean concave points (32\%), worst area (18\%).
