...
The 14.5\% after 1-epoch fine-tuning is a lower bound on attention
instability: longer training (more epochs) or larger learning rates
would explore more of the Rashomon set and likely produce higher
flip rates. The true instability under standard fine-tuning practice
(3--5 epochs) likely lies between the fine-tuning lower bound (14.5\%)
and the perturbation upper bound (88\%).
