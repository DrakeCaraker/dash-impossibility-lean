...
\texttt{splitCount}, \texttt{firstMover}), and the 10 property axioms below.

\begin{table}[h]
\centering
\caption{Complete axiom inventory (16 total).}
\label{tab:axioms}
\small
...
The formalization comprises 14 Lean~4 files with 16 axioms and
47 type-checked declarations (38 theorems + 9 lemmas;
0 \texttt{sorry}). Of these, 41 require multi-line proofs
...
\begin{verbatim}
Defs.lean (16 axioms, type definitions, derived theorems)
  |
