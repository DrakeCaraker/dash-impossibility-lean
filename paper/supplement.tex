...
Table~\ref{tab:axioms} lists all axioms in the Lean~4 formalization.
...
Spearman bound & \texttt{spearman\_bound} & Combinatorial rank argument: tied non-first-movers \\
...
The formalization comprises 12 Lean~4 files with 29 theorems:

\begin{verbatim}
Defs.lean (6 axioms, type definitions)
  |
