...
In a survey of 37 public datasets (supplement), 92\% have feature pairs with $|\rho| > 0.5$ and 70\% exhibit attribution instability (flip rate $> 10\%$) --- the impossibility is not a theoretical curiosity but a practical reality affecting the majority of real-world data.
