...
\begin{enumerate}
    ...
    \item \textbf{Machine-verified proof}: The argument is formalized in Lean~4 (42 type-checked declarations from 15 axioms, 0 \texttt{sorry}), publicly available at \url{[anonymized for review]}.
\end{enumerate}
