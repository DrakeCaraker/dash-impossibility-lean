...
The proof is mechanically verified in Lean~4 using Mathlib: 260 type-checked theorems across 46 files from 16 axioms with 0 \texttt{sorry}.
...
\begin{enumerate}
    ...
    \item \textbf{Machine-verified proof}: formalized in Lean~4 (260 theorems from 16 axioms, 0 \texttt{sorry}), publicly available at \url{[anonymized for review]}.
\end{enumerate}
