...
The proof is mechanically verified in Lean~4 using Mathlib: 227 type-checked theorems across 42 files from 16 axioms with 0 \texttt{sorry}.
...
\begin{enumerate}
    ...
    \item \textbf{Machine-verified proof}: formalized in Lean~4 (227 theorems from 16 axioms, 0 \texttt{sorry}), publicly available at \url{[anonymized for review]}.
\end{enumerate}
...
The core impossibility is Lean-verified with zero axiom dependencies. The full formalization comprises 227 theorems from 16 axioms with 0 \texttt{sorry} across 42 files (supplement).
