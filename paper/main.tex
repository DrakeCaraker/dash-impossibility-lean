...
(A real-world validation on the Breast Cancer dataset, confirming
instability for naturally collinear features, is in the supplement.)
...
\DASH{} requires $M\times$ training cost; at $M = 25$, this is practical for models training in under one hour but may be prohibitive for very large models.
