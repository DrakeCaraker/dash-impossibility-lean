...
The proof is mechanically verified in Lean~4 using Mathlib: 190 type-checked theorems across 36 files from 17 axioms with 0 \texttt{sorry}.
...
\begin{enumerate}
    ...
    \item \textbf{Machine-verified proof}: formalized in Lean~4 (190 theorems from 17 axioms, 0 \texttt{sorry}), publicly available at \url{[anonymized for review]}.
\end{enumerate}
...
The core impossibility is Lean-verified with zero axiom dependencies. The full formalization comprises 190 theorems from 17 axioms with 0 \texttt{sorry} across 36 files (supplement).
