...
The proof axiomatizes gradient boosting via split-count formulas (SymPy-verified) rather than deriving them from algorithmic definitions; deriving the axioms in Lean~4 remains open.
