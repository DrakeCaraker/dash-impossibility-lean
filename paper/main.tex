...
The entire proof---28 substantive theorems verified by the Lean~4 type checker, plus one variance bound stated but not yet formally proved---is mechanically verified, constituting the first formally verified impossibility result in explainable AI.
\end{abstract}
...
The proof is mechanically verified in Lean~4 using Mathlib: 28 substantive theorems with no unresolved goals. One additional bound (consensus variance $O(1/M)$) is stated but not yet formally proved, pending Mathlib measure-theoretic infrastructure.
...
\begin{enumerate}
    ...
    \item \textbf{Machine-verified proof}: The entire argument is formalized in Lean~4 (28 substantive theorems, 0 \texttt{sorry}), publicly available at \url{[anonymized for review]}.
\end{enumerate}
...
The variance bound is stated but not yet formally proved, pending Mathlib infrastructure.
...
\begin{enumerate}
\item \textbf{Claims.} All theoretical claims are formally verified by the Lean~4 type checker (28 substantive theorems, 0 \texttt{sorry}; one variance bound stated but not yet proved). Empirical claims are backed by experiments over 50 random seeds. [Yes]
