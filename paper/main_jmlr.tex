...
\begin{abstract}
Feature attribution rankings under collinearity are provably unreliable: we establish that faithfulness, stability, and completeness are mutually incompatible, characterize the complete design space (exactly two achievable families), and give the provably optimal resolution.
