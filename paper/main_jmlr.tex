...
\begin{table}[t]
\centering
\caption{Complete axiom inventory (10 total: 5 type/constant, 3 property, 2 measure). Six former axioms (split-count function, 4 split-count properties, query-complexity constant) are now definitions or derived theorems.}
\label{tab:axioms}
\footnotesize
...
The formalization comprises 58 Lean~4 files with 6 axioms and 352 type-checked theorems and lemmas (0~\texttt{sorry}). Of these, 115 require multi-line proofs ($\geq$5 tactic lines); the remainder are definitions, wrappers, and single-step applications.
...
Of 350 type-checked declarations: 115 require multi-step proofs (${\geq}5$ tactic lines), 21 require ${\geq}10$ lines, and 5 require ${\geq}20$ lines. The five deepest proofs are listed below.
