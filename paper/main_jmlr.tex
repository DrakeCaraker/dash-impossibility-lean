...
The formalization comprises 46 Lean~4 files with 16 axioms and 260 type-checked theorems and lemmas (0~\texttt{sorry}). Of these, 67 require multi-line proofs ($\geq$5 tactic lines); the remainder are definitions, wrappers, and single-step applications.
...
$\rho_S \leq 1 - 3(m{-}1)^2/(P^3{-}P)$.
The paper uses the Lean-derived bound $\rho_S \leq 1 - 3(m{-}1)^2/(P^3{-}P)$. The tighter classical bound $\rho_S \leq 1 - m^3/P^3$ from the full rank transposition counting argument is not yet formalized; both give the same qualitative conclusion ($S < 1$ for within-group pairs).
...
Of 260 type-checked declarations: 67 require multi-step proofs (${\geq}5$ tactic lines), 21 require ${\geq}10$ lines, and 5 require ${\geq}20$ lines. The five deepest proofs are listed below.
