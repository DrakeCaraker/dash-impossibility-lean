...
The paper uses the tighter classical bound $\rho_S \leq 1 - m^3/P^3$; closing the gap requires a combinatorial counting argument (bounding the transposition effect on midranks in $\sum d_i^2$ under random tie-breaking) not yet available in the Lean~framework.
