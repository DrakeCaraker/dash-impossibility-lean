...
The formalization uses 6 axioms total: 5 type/constant declarations, 2 measure-theoretic infrastructure axioms, and 3 domain-specific property axioms. The split-count structure and query-complexity constant are now derived (see \S~\ref{sec:lean}).
...
The formalization comprises 58 Lean~4 files with 6 axioms and 350 type-checked theorems and lemmas (0~\texttt{sorry}). Of these, 115 require multi-line proofs ($\geq$5 tactic lines); the remainder are definitions, wrappers, and single-step applications.
