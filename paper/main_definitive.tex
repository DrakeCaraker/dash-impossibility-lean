...
The proof is mechanically verified in Lean~4 using Mathlib: 305 type-checked theorems and lemmas across 54 files (67 with multi-step proofs of ${\geq}5$ tactic lines; the remainder are definitions, wrappers, and single-step applications; from 14 domain-specific + 2 query-complexity axioms; 0 \texttt{sorry}).
