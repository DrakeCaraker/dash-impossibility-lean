...
\textbf{Verification.} The framework is mechanically verified in Lean~4: 203 theorems from 16 axioms with 0 \texttt{sorry} across 40 files. The formalization caught two logical inconsistencies that survived informal review.
