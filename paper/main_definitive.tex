...
This document is the complete reference: impossibility theorem, quantitative bounds, constructive resolution, three Symmetric Bayes Dichotomy (SBD) instances, diagnostics, experiments across 11 datasets and 3 GBDT implementations, financial case studies, and a 340-theorem Lean~4 formalization.
...
The formalization began with 16 axioms and was reduced to 6 through three rounds of ``define rather than axiomatize'':
\begin{itemize}
