...
\textbf{Verification.} The framework is mechanically verified in Lean~4: 305 theorems from 16 axioms with 0 \texttt{sorry} across 54 files. The formalization caught two logical inconsistencies that survived informal review.

\textbf{Code.} Reference implementation:
...
This document is the complete reference: impossibility theorem, quantitative bounds, constructive resolution, three SBD instances, diagnostics, experiments across 11 datasets and 3 GBDT implementations, financial case studies, and a 305-theorem Lean~4 formalization.
...
\begin{enumerate}
    ...
    from 16 axioms, 0 \texttt{sorry}), publicly available at\\
    \url{https://github.com/DrakeCaraker/dash-impossibility-lean}.
    The axiom system is consistent: we construct an explicit model satisfying all
    14 domain-specific axioms simultaneously, both in Lean
    (\texttt{Consistency.lean}) and numerically.
\end{enumerate}
\end{sloppypar}
