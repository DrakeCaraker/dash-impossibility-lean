...
\noindent\textbf{Verification.} The framework is mechanically verified in Lean~4: 358 theorems from 6 axioms with 0 \texttt{sorry} across 58 files. The formalization caught three inconsistencies (two logical and one type mismatch) that survived informal review.
...
\begin{sloppypar}
The formalization comprises 58 Lean~4 files with 6 axioms and 358 type-checked
...
\begin{table}[t]
\centering
\caption{Lean file cross-reference (58 files, 358 theorems, 6 axioms).}
...
\noindent\textbf{Lean formalization.} The 358-theorem, 6-axiom, 0-\texttt{sorry} formalization is available at \url{https://github.com/DrakeCaraker/dash-impossibility-lean} (archived at \url{https://doi.org/10.5281/zenodo.19468379}).
