...
\textbf{Verification.} The framework is mechanically verified in Lean~4: 227 theorems from 16 axioms with 0 \texttt{sorry} across 42 files. The formalization caught two logical inconsistencies that survived informal review.
