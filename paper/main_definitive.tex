...
\item \textbf{Proof tactics (AI-assisted).} Approximately 80\% of tactic-mode proofs were initially drafted by Claude Code and then verified, corrected, or restructured by the first author. The initial formalization (49 theorems) was developed iteratively; the expansion to 357 theorems was produced by dispatching targeted Lean-writing agents with detailed specifications.
