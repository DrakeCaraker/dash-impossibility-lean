...
- **Lean formalization**: 352 theorems, 6 axioms, 0 sorry, 58 files. Builds with `lake build`.
...
3. **Axiom plausibility**: Read the 6 axioms (6 axioms) — are they reasonable idealizations?
