...
![Theorems](https://img.shields.io/badge/theorems-260-blue)
...
│
├── DASHImpossibility/                    # 46 Lean 4 files, 260 theorems, 16 axioms, 0 sorry
│   │
│   │  ── Level 0: Pure Logic ──
...
│   └── Basic.lean                        # Import hub (all 46 files)
│
├── paper/
...
**260 theorems. 16 axioms. 0 sorry. 46 files. 13 abstraction levels. 67 multi-step proofs (>=5 tactic lines).**
